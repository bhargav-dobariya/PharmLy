...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<bool> onExitDialogue()async{
    return (await showDialog(
      context: context,
      builder: (context)=>AlertDialog(
        title: Text(AppString.txtExitConfirmation),
        content: Text(AppString.txtExitConfirmationBody),
        actions: [
          TextButton(
            onPressed: (){
              Navigator.pop(context,false);
            },
            child: Text(AppString.txtNo)
          ),
          TextButton(
              onPressed: (){
                Navigator.pop(context,true);
              },
              child: Text(AppString.txtYes)
          )
        ],
      )
    )
