...
class DiseasesProduct extends StatefulWidget {
  ...
  const DiseasesProduct({Key? key, required this.index, required this.snap})
      : super(key: key);

  @override
  _DiseasesProductState createState() => _DiseasesProductState();
}

class _DiseasesProductState extends State<DiseasesProduct> {
